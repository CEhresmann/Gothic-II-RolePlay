...
addEventHandler("onInit", function(){
	createMonster("ORCWARRIOR_REST", 5827.76, 368.196, -2288.79, 60);
	createMonster("ORCELITE_REST", 6027.76, 368.196, -2288.79, 60);
	createMonster("SCAVENGER", 7441.31, 512.177, -8995.67, 188.303); 
