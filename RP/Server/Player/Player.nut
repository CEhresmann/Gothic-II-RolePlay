class _Player
{
    ...
    function disconnect(reason)
    {
        ...
        {
            try {
                // The values are already up-to-date in the 'this' object.
