class AIAgressive extends AIBase {
    // USUŃ inicjalizację właściwości tutaj
    enemy_id = null
    collect_target = null
    weapon_mode = null
    ...
    constructor(npc_id) {
        ...
        // INICJALIZUJ właściwości TUTAJ, w konstruktorze
        this.enemy_id = -1;
        this.collect_target = AI_CollectNearestTarget; // Teraz funkcja jest dostępna
