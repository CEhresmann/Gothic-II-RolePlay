...
Interface.BW <- {
    ...
    function show() {
        ...
        isBWActive = true;
        ShowChat(true);
		this.Topic.label.setText("Jesteś nieprzytomny, obudzisz się za:");
...
Interface.BW.Topic <- GUI.Button({
    ...
    file = "MENU_INGAME.TGA",
    label = {text = "Jesteś nieprzytomny, obudzisz się za:"},
...
function showChoiceButtons() {
    ...
    Interface.BW.Topic.label.setText("Wybierz co chcesz zrobić:");
}
