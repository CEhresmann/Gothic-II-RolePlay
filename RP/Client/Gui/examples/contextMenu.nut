...
local function colorOption_onClick(self)
{
	...
	selectedRow.setLabelColor(clone dataRow.getLabelColor())
}
...
addEventHandler("onInit", function()
{
	...
	colorContextMenu.addRow({text = "Change color to red", labelColor = Color(255, 0, 0), file = "INV_SLOT.TGA"})
	colorContextMenu.addRow({text = "Change color to green", labelColor = Color(0, 255, 0), file = "INV_SLOT.TGA"})
	colorContextMenu.addRow({text = "Change color to blue", labelColor = Color(0, 0, 255), file = "INV_SLOT.TGA"})
