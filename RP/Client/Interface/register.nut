...
Interface.Register.logo <- GUI.Label({
...
addEventHandler("GUI.onClick", function(self)
{
	...
	switch (self)
	{
		...
		case Interface.Register.registerButton:
			...
			Player.packetRegister(Interface.Register.username.getText(), Interface.Register.password.getText());
		break;
	}
})
