...
Interface.Settings.musicVolumeLabel <- GUI.Label({
    ...
    label = {text = "Głośność muzyki: " + (Music.volume * 100).tointeger() + "%"},
    collection = Interface.Settings.window
})
...
Interface.Settings.fovLabel <- GUI.Label({
    relativePositionPx = {x = 0.01 * Resolution.x, y = 0.18 * Resolution.y},
    label = {text = "FOV kamery: 75"},
    collection = Interface.Settings.window
})
...
function loadSettings() {
    ...
    Interface.Settings.musicVolumeLabel.setText("Głośność muzyki: " + validMusicVolume.tointeger() + "%");
...
function onMusicVolumeChanged(self) {
    ...
    Interface.Settings.musicVolumeLabel.setText("Głośność muzyki: " + value.tointeger() + "%");
    saveSettings();
}
...
function resetMusicVolume(self) {
    ...
    Interface.Settings.musicVolumeLabel.setText("Głośność muzyki: " + defaultMusicVolume.tointeger() + "%");
    saveSettings();
}
