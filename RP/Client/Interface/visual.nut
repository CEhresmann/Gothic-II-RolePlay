...
Interface.Visual <- {
    ...
    "showCurrentOption" : function(opt) {
        ...
        switch (opt)
        {
            ...
            case 3:
                this.changingElements = [
                    GUI.Button({ positionPx = { x = 0.7 * Resolution.x, y = 0.31 * Resolution.y }, sizePx = { width = 0.2 * Resolution.x, height = 0.05 * Resolution.y }, file = "MENU_INGAME.TGA", label = { text = _L("Head") + " 1" } }),
                    GUI.Button({ positionPx = { x = 0.7 * Resolution.x, y = 0.37 * Resolution.y }, sizePx = { width = 0.2 * Resolution.x, height = 0.05 * Resolution.y }, file = "MENU_INGAME.TGA", label = { text = _L("Head") + " 2" } }),
                    GUI.Button({ positionPx = { x = 0.7 * Resolution.x, y = 0.43 * Resolution.y }, sizePx = { width = 0.2 * Resolution.x, height = 0.05 * Resolution.y }, file = "MENU_INGAME.TGA", label = { text = _L("Head") + " 3" } }),
                    GUI.Button({ positionPx = { x = 0.7 * Resolution.x, y = 0.49 * Resolution.y }, sizePx = { width = 0.2 * Resolution.x, height = 0.05 * Resolution.y }, file = "MENU_INGAME.TGA", label = { text = _L("Head") + " 4" } }),
                    GUI.Button({ positionPx = { x = 0.7 * Resolution.x, y = 0.55 * Resolution.y }, sizePx = { width = 0.2 * Resolution.x, height = 0.05 * Resolution.y }, file = "MENU_INGAME.TGA", label = { text = _L("Head") + " 5" } }),
                    GUI.Button({ positionPx = { x = 0.7 * Resolution.x, y = 0.61 * Resolution.y }, sizePx = { width = 0.2 * Resolution.x, height = 0.05 * Resolution.y }, file = "MENU_INGAME.TGA", label = { text = _L("Head") + " 6" } })
                ];
            break;
            case 4:
