...
addEventHandler("onInit", function() {
    ...
    icButton = GUI.Button({
        ...
        file = "INV_SLOT_FOCUS.TGA", label = { text = "IC" }, collection = chatModeWindow
    });
    oocButton = GUI.Button({
        relativePositionPx = { x = 105, y = 5 }, sizePx = { width = 90, height = 40 },
        file = "INV_SLOT_FOCUS.TGA", label = { text = "OOC" }, collection = chatModeWindow
    });
