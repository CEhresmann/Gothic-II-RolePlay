Interface.TradingMenu <- {
    ...
    "showItemTooltip" : function(itemName, itemInstance) {
		...
		this.itemTooltipBackground = GUI.Sprite({
		...
		this.itemTooltipText = GUI.Label({
...
Interface.TradingMenu.Topic <- GUI.Label({
